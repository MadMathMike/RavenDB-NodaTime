...
namespace Raven.Client.NodaTime.Tests
{
    public class MyRavenDBLocator : RavenServerLocator
    {
        ...
        public override string ServerPath
        {
            get
            {
                return @"C:\users\michpete\Downloads\RavenDB-4.0.0-windows-x64\Server\Raven.Server.exe";
        ...
        public override string Command => @"C:\users\michpete\Downloads\RavenDB-4.0.0-windows-x64\Server\Raven.Server.exe";
